        ...
        () => Scaffold(
          ...
          body: Padding(
            ...
            child: Column(
              ...
              children: [
                if (Base.controller.isTiming.value || Base.controller.isPause.value)
                  Row(
                    children: [
                      Container(
                        height: 50,
                ...
                if (Base.controller.isPause.value)
                  KText(
                    text: 'Break',
                    color: Colors.black54,
                  ),
